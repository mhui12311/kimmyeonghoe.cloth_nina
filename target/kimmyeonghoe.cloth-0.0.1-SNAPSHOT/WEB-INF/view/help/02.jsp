		...
		<div class='col-3'>
			<table class='table table-bordered'>
	            ...
	            <tbody class='text-center'>
	               ...
	               <tr>
	                  <td><a href = "../notice/04.html">FAQ<br>(자주하는 질문)</a></td>
	               </tr>
	               <tr>
		...
		<div class='col-9'>
		   <div class='row'>
			...
			<form>
	            <table class='table'>
	               <tbody>
	                  <tr><td class='text-center'><b>제목</b></td><td><input type='text' id='title'></td><td></td></tr>
	                  <tr><td class='text-center'><b>작성자</b></td><td><p>user</p></td><td></td></tr>
	                  <tr><td class='text-center'><b>문의 내용</b></td><td><textarea cols='38' rows='5'></textarea></td><td></td></tr>
	                  <tr>
	                  ...
	                  <tr>
	                  	...
	                  	<td><input type='file' id='myImage' name='myImage' accept='.jpg, .jpeg, .png, .gif'/></td><td></td>
	                  </tr>
	               </tbody>
	            </table>
    	  	</form>
			<a href='01.html'><button class='btn btn-secondary float-right'>등록</button></a>
       </div>
	</div>
</div>
	...
	<div class='modal-dialog'>
		<div class='modal-content'>
			...
			<div class='modal-footer'>
				...
				<button type='button' class='btn btn-secondary' id='delCartOkBtn'>예</button>
			</div>
		</div>
	</div>
</div>
